...
TEST(Logger, Output) {
    ...
    std::streambuf* oldCoutBuffer = std::cout.rdbuf(output.rdbuf());
    {
        ...
        CubeLog logger = CubeLog(LogVerbosity::TIMESTAMP_AND_LEVEL_AND_FILE_AND_LINE_AND_FUNCTION_AND_NUMBEROFLOGS, LogLevel::LOGGER_DEBUG, LogLevel::LOGGER_OFF);
...
TEST(Logger, LogToFile){
    ...
    {
        // Call the function that prints to stdout
        CubeLog logger = CubeLog(LogVerbosity::TIMESTAMP_AND_LEVEL_AND_FILE_AND_LINE_AND_FUNCTION_AND_NUMBEROFLOGS, LogLevel::LOGGER_OFF, LogLevel::LOGGER_DEBUG);
